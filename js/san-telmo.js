...
const projects = {
    ...
    'plaza-dorrego': {
        title: 'Plaza Dorrego - Corazón Verde Adaptativo',
    ...
    'patios-huerta': {
        title: 'Red de Patios-Huerta Compartidos',
...
1. **Coordenadas reales y precisas** para cada ubicación
2. **Descripciones mundanas** (sin tecnología fantástica)
3. **Futuro cercano** (menciona 2026-2030 como fechas de implementación)
4. **Categorías correctas** en data-category para el filtrado
5. **IDs consistentes** entre HTML y JS
6. **Zoom del mapa a 16** para ver mejor las 6 ubicaciones cercanas

---

## 🗺️ VERIFICACIÓN DE COORDENADAS

Las 6 ubicaciones están muy cerca entre sí (como debe ser en San Telmo):
```
1. Mercado: -34.6214, -58.3725
2. Refugios: -34.6216, -58.3728 (2 cuadras del mercado)
3. Cisterna: -34.6207, -58.3722 (1 cuadra del mercado)
4. Calles: -34.6210, -58.3724 (eje central)
5. Plaza: -34.6218, -58.3726 (1 cuadra del mercado)
6. Patios: -34.6220, -58.3735 (4 cuadras del mercado)
